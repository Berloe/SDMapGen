 ...
 * allows us to create a page that is small and knows how to save, restore and apply itself. This page is used to modify preferences only. They are stored in the preference store that belongs to the
...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public void createFieldEditors() {
        addField(new DirectoryFieldEditor(PreferenceConstants.P_PATHCLASSREPO, Messages.PreferencePage_0, getFieldEditorParent()));
        addField(new StringFieldEditor(PreferenceConstants.INPUT_SUFFIX, Messages.PreferencePage_2, -1, StringFieldEditor.VALIDATE_ON_KEY_STROKE, getFieldEditorParent()));
        addField(new StringFieldEditor(PreferenceConstants.OUTPUT_SUFFIX, Messages.PreferencePage_3, -1, StringFieldEditor.VALIDATE_ON_KEY_STROKE, getFieldEditorParent()));
    ...
    private String[][] getFormattingDefaults() {
        final String[][] out = new String[4][2];
