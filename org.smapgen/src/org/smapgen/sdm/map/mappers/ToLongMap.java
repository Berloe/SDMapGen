...
public class ToLongMap extends Mapper implements IMapper {
    ...
    public StringBuffer map(final String sourceName, final String targetName, final MappingField sourceField, final MappingField targetField) {
        if (sourceField.getFieldType().equals(byte[].class) || sourceField.getFieldType().equals(char[].class)) {
            return new StringBuffer(targetField.getVarName() + "." + targetField.getSetterMethod().getName() + "(new Long(new String(" + sourceField.getVarName() + ")));");
            ...
            return new StringBuffer(targetField.getVarName() + "." + targetField.getSetterMethod().getName() + "(new Long(" + sourceField.getVarName() + "));");
        } else if (sourceField.getFieldType().equals(byte.class)) {
            return new StringBuffer(targetField.getVarName() + "." + targetField.getSetterMethod().getName() + "(new Byte(" + sourceField.getVarName() + ").longValue();");
        } else if (sourceField.getFieldType().equals(Byte.class)) {
            return new StringBuffer(targetField.getVarName() + "." + targetField.getSetterMethod().getName() + "(" + sourceField.getVarName() + ").longValue();");
        }
    ...
    private Boolean isAssignablePrimitive(final MappingField sourceField) {
        return char[].class.isAssignableFrom(sourceField.getFieldType()) || byte[].class.isAssignableFrom(sourceField.getFieldType()) || int.class.isAssignableFrom(sourceField.getFieldType()) || long.class.isAssignableFrom(sourceField.getFieldType()) || byte.class.isAssignableFrom(sourceField.getFieldType());
    }
    ...
    private boolean isPrimitive(final MappingField sourceField) {
        return sourceField.getFieldType().equals(char[].class) || sourceField.getFieldType().equals(byte[].class) || sourceField.getFieldType().equals(int.class) || sourceField.getFieldType().equals(long.class) || sourceField.getFieldType().equals(byte.class);
    }
}